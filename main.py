...
#login from os
login = os.getlogin()
print("You are logging from : "+str(login))

#Choices
print("1. Composed a mail.")
tts = gTTS(text="option 1. Composed a mail.", lang='en')
ttsname = "E:\Python Project\Mouse\VBEmail System/hello.mp3"
tts.save(ttsname)
...
if int(text)== 1:
    ...
    mail.login("youremail@gmail.com","------------------------")  #logIn part
    mail.sendmail("youremail@gmail.com","sendingmail1@gmail.com",msg)  #SEND PART
    print("Congrates! Your mail has send. ")
    tts = gTTS(text = "Congrates! Your mail has send.", lang='en')
    ttsname = "E:\Python Project\Mouse\VBEmail System/send.mp3"
    tts.save(ttsname)
    music = pyglet.media.load(ttsname,streaming=False)
    music.play()
    time.sleep(music.duration)
...
if int(text) == 5:
    mail = imaplib.IMAP4_SSL('imap.gmail.com')  #this is a host and port area.....ssl security
    unm = "youremail@gmail.com"  #username
    psw = "---------------------------"  #password
    ...
    tts = gTTS(text = "Total mails are: " +str(total))
    ttsname = "E:\Python Project\Mouse\VBEmail System/total.mp3"
    tts.save(ttsname)
    music = pyglet.media.load(ttsname,streaming=False)
    music.play()
    time.sleep(music.duration)
    ...
    ttsname = "E:\Python Project\Mouse\VBEmail System/unseen.mp3"
    tts.save(ttsname)
    music = pyglet.media.load(ttsname,streaming=False)
    music.play()
    time.sleep(music.duration)
    ...
    ttsname = "E:\Python Project\Mouse\VBEmail System/mail.mp3"
    tts.save(ttsname)
    music = pyglet.media.load(ttsname,streaming=False)
    music.play()
    time.sleep(music.duration)
    ...
    txt = soup.get_text()
    print("Body : " +txt)
    tts = gTTS(text="Body: " +str(txt),lang='en')
    ttsname="E:\Python Project\Mouse\VBEmail System/body.mp3"
    tts.save(ttsname)
    music = pyglet.media.load(ttsname,streaming=False)
    music.play()
    time.sleep(music.duration)
